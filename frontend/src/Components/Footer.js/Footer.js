                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="mb-5"><a href="/">
                                ...
                                <a class="text-white-70"
                                    href="/"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        ...
                                        class="feather feather-instagram icon mr-1">
                                        <g>
                        ...
                        <div class="offset-lg-1 col-lg-7">
                            <div class="row">
                                <div class="col-md-4">
                                    <h4 class="text-white f-22 fw-normal mb-3">Customer</h4>
                                    <ul class="list-unstyled footer-sub-menu">
                                        <li><a class="footer-link" href="/">Works</a></li>
                                        <li><a class="footer-link" href="/">Strategy</a></li>
                                        <li><a class="footer-link" href="/">Releases</a></li>
                                        <li><a class="footer-link" href="/">Press</a></li>
                                        <li><a class="footer-link" href="/">Mission</a></li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <h4 class="text-white f-22 fw-normal mb-3">Product</h4>
                                    <ul class="list-unstyled footer-sub-menu">
                                        <li><a class="footer-link" href="/">Tranding</a></li>
                                ...
                                <div class="col-md-4">
                                    <h4 class="text-white f-22 fw-normal mb-3">Learn More</h4>
                                    <ul class="list-unstyled footer-sub-menu">
                                        ...
                                        <li><a class="footer-link" href="/">Get Started</a></li>
                                        <li><a class="footer-link" href="/">Guide</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt-5">
                                <p class="text-white-50 f-15 mb-0">2025 © Nody. Develop By Narendra Singh</p>
                            </div>
                        </div>
                    </div>
                </div>
